export const COIN_GECKO_MARKET_URL =
    `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&price_change_percentage=24h,7d,30d,1y&per_page=250`
...
export const DEFAULT_LOADING_TIMEOUT = 500
